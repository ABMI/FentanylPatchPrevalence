...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37108790,4147954,19124480,19113040,19127670,751246,767410,19071900,19071910)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37108790,4147954,19124480,19113040,19127670,751246,767410,19071900,19071910)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4168389,432590,375229,439706,436073,44805670)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4168389,432590,375229,439706,436073,44805670)
  and c.invalid_reason is null
...
WHERE C.procedure_date >= DATEFROMPARTS(2016, 1, 1)
